package io.github.patriciastarck.literalura.model;

import io.github.patriciastarck.literalura.dto.AutorDTO;
...
public class Autor {
    ...
    public String toString(){
        String anoNascimentoString = anoNascimento != null ? anoNascimento.toString() : "Desconhecido";
        String anoFalecimentoString = anoFalecimento != null ? anoFalecimento.toString() : "Desconhecido";
        return "Autor: " + autor + " (nascido em " + anoNascimentoString + ", falecido em " + anoFalecimentoString + ")";
    }
}
