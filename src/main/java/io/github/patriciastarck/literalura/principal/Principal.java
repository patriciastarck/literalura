...
import io.github.patriciastarck.literalura.service.IConverteDados;
...
public class Principal {
    ...
    private void listarAutoresVivos() {
        ...
        List<Autor> autores = livroRepository.findByAutoresVivos(year);
        if (autores.isEmpty()) {
    ...
    private void listarAutoresVivosRefinado() {
        ...
        List<Autor> autores = livroRepository.findByAutoresRefinados(year);
        if (autores.isEmpty()) {
            System.out.println("Nenhum autor vivo encontrado.");
        } else {
    ...
    private void listarAutoresPorAnoDeMorte() {
        ...
        List<Autor> autores = livroRepository.findyAutoresPorAnoDeMorte(year);
        if (autores.isEmpty()) {
            System.out.println("Nenhum autor vivo encontrado.");
        } else {
